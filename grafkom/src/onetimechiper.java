...
//import static OneTimePadCipher.encryptionMessage;
...
public class onetimechiper {
	    ...
	    public static void main(String[] args)
	    {
	       ...
	       // System.out.println("'" + message + "' ENKRIPSI PESAN : "
	        //        + encryptionMessage(message));
	      System.out.println("'"  + decryptionMessage((message)));
	        sc.close();
	    }
}	 
